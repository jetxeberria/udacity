...
from udacity.neo_project.helpers import do_datetime
...
TEST_NEO_PROJECT = Path(PROJECT_PATH, "udacity", "neo_project", "tests")
...
def assert_approaches_in_range(filtered_approaches, start_date="2020-01-01", end_date="2020-12-31"):
...
def test_query_g_start_date_w_filtered_t_found(real_neos_db):
    ...
    assert_approaches_in_range(filtered_approaches, start_date="2020-01-01", end_date="2020-12-31")
